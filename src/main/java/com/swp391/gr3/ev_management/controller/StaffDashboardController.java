                ...
                .map(booking -> {
                    ...
                    if (vehicle != null) {
                        if (vehicle.getDriver() != null
                                ...
                                && vehicle.getDriver().getUser().getName() != null) {
                            driverName = vehicle.getDriver().getUser().getName();
                        }
                    ...
                    String stationName = booking.getStation() != null
    ...
    public ResponseEntity<List<ActivityResponse>> getRecentActivities(
        ...
        recentBookings.forEach(booking -> {
            ...
            if (booking.getVehicle() != null
                    ...
                    && booking.getVehicle().getDriver().getUser().getName() != null) {
